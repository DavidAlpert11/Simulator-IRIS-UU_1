...
%%
[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.X_armX,Quad.X_armY,Quad.X_armZ,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.X_arm,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))

[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.Y_armX,Quad.Y_armY,Quad.Y_armZ,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.Y_arm,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))

[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.Motor1X,Quad.Motor1Y,Quad.Motor1Z,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.Motor1,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))

[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.Motor2X,Quad.Motor2Y,Quad.Motor2Z,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.Motor2,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))

[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.Motor3X,Quad.Motor3Y,Quad.Motor3Z,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.Motor3,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))

[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.Motor4X,Quad.Motor4Y,Quad.Motor4Z,RecordState.phi(i),RecordState.theta(i),RecordState.psi(i));
set(Quad.Motor4,'xdata',Quad.Xtemp+RecordState.X(1,i),'ydata',(Quad.Ytemp+RecordState.X(2,i)),'zdata',(Quad.Ztemp+RecordState.X(3,i)))
