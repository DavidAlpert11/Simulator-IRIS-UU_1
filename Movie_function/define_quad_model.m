...
Quad.plot_arm_t = .05*factor;   %Thickness of the quadrotor's arms for drawing purposes (m)
...
Y_arm=patch('faces',face_matrix,...
 ...
 Motor1 = patch(X+Quad.plot_arm,Y,Z,C,'facealpha',1,'facecolor',[1 0.5 0]); %(Motor 1)
 Motor2 = patch(X,Y-Quad.plot_arm,Z,C,'facealpha',1,'facecolor',[1 0.5 0]); %(Motor 2)
 Motor3 = patch(X-Quad.plot_arm,Y,Z,C,'facealpha',1,'facecolor',[1 0.5 0]); %(Motor 3)
 Motor4 = patch(X,Y+Quad.plot_arm,Z,C,'facealpha',1,'facecolor',[1 0.5 0]); %(Motor 4)
